...
bool IPCManager::add_to_event(int epoll_fd , epoll_event& ev , int fd){
  ev.events = EPOLLIN;
  ev.data.fd = fd;
...
std::string IPCManager::read_prompt() {
...
bool IPCManager::write_infered(const std::string& tok){
